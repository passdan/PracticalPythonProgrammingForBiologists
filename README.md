...
These materials are designed for use in live training sessions and therefore have spaces where explanations, demonstrations, and solutions would be discussed and shown. Also there are supplementary presentations in a live course, and not all of the data-files are stored in the github repository and you will need to source them yourself. If you're using these sessions outside of a course delivered by Compass Bioinformatics please [read this agreement page](Images/CompassBioinformatics-OnePage.png). If you're interested in joining a planned live course, organising a bespoke one, or contracting for data analysis then please get in touch via our email.
